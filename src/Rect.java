...
public class Rect
{
	...
	public Rect(int x, int y, Color color, int width, int height , String bokstav_)//konstruktorn
	{
		...
		//... Initiate Images
		try{image = ImageIO.read(getClass().getResource("Untitled-10.png"));}
        catch(IOException ex){}
		try{alive_image = ImageIO.read(getClass().getResource("Untitled-12.png"));}
        catch(IOException ex){}
		try{dead_image = ImageIO.read(getClass().getResource("Untitled-11.png"));}
        catch(IOException ex){}
	}
	public void move()
	{
